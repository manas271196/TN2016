	...
	var tamil:{
			...
			"Chepauk-Thiruvallikeni":"சேப்பாக்கம்",
			...
			"Sriperumbudur":"திருப்பெரும்புதூர்",
	...
	function toolin(path,factor){
		...
		d3.selectAll("."+consti_number).each(function(d){
			...
			if(year1!="2016"){
				...
				tool.append("span").style("font-size","18px").style("font-weight","bold").text(tamil[d.properties.AC_NAME]+"\n");
				tool.append("span").style("font-size","16px").text(win[+(d.properties.AC_NO)][+year1])+"\n";
